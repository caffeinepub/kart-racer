...
export class Backend implements backendInterface {
    ...
    async getRaceDetails(arg0: string): Promise<RaceEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.getRaceDetails(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getTrackLeaderboard(arg0: string): Promise<Array<[string, Time]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrackLeaderboard(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTracks(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async saveRaceDetails(arg0: string, arg1: string, arg2: string, arg3: Time, arg4: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveRaceDetails(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
