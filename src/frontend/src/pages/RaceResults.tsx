...
export default function RaceResults({
  ...
  const handleSave = () => {
    if (username.trim() && character) {
      saveRace(username.trim(), character.name, 'Rainbow Circuit', completionTime);
    }
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="bg-white/95 backdrop-blur rounded-3xl shadow-2xl p-8 max-w-2xl w-full">
        <div className="flex items-center justify-center mb-6">
          ...
          <h1 className="text-5xl font-bold text-racing-blue">Race Complete!</h1>
        </div>
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center text-2xl text-muted-foreground">
            ...
            <span className="font-mono font-bold">{formatTime(completionTime)}</span>
          </div>
        </div>
        ...
        {!isSaved ? (
          <div className="space-y-4 mb-6">
            <div>
              <label className="block text-sm font-semibold mb-2">Save your time to the leaderboard:</label>
              <Input
                type="text"
